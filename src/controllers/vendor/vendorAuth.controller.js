...
const signup = async (req, res) => {
  try {
    ...
    return success(res, HttpStatus.OK, Messages.OTP_SENT_SUCCESS, { redirectUrl: "/vendor/verify-otp" });
  } catch (error) {
...
const verifyOtp = async (req, res) => {
  try {
    ...
    await Vendor.findByIdAndUpdate(newVendor._id, { wallet: newWallet._id });
      ...
      return success(res, HttpStatus.OK, Messages.VENDOR_REGISTER_SUCCESS, {redirectUrl: "/vendor/login"});
  } catch (error) {
...
const login = async (req, res) => {
  try {
    ...
    return success(res, HttpStatus.OK, Messages.LOGIN_SUCCESS, {redirectUrl: "/vendor/dashboard"});
